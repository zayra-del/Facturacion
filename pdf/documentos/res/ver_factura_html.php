        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "sistemaFacturacion "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #34495e;font-size:12px;text-align:center">
                ...
                Sistema Facturación UMG</span><br>
				Dirección: Guatemala<br> 
				Teléfono: (502) 7945-4589<br>
				Email: sistemaFacturacion@gmail.com
...
?>
		...
		<tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">IVA (<?php echo TAX; ?>)% Q </td>
